...
namespace MGS3_MC_Cheat_Trainer
{
    public class Constants
    {
        ...
        public static class AlertOffsets
        {
            public const int AlertTimerOffset = 0; // Offset for the alert timer from the start of the AlertMemoryRegion
            public const int CautionTimerOffset = 8; // Offset for the caution timer
            public const int EvasionTimerOffset = 16; // Offset for the evasion timer
